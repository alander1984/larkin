...
skip_before_action :verify_authenticity_token
	...
	def create
		...
		@rowCount = csv.count;
		#TODO вынести загрузку джобами или онлайн в настройку
		ImportControllerWorker.perform_async(@import.id); 
		#ну есть еще синхронный метод. Его удобно использовать для отладки
		#perform(csv);
